...
| `wang2024` | whitepaper | Wang, Lin, Han, Chen, Cao, Sun, "Towards universal dense blocking for entity resolution", arXiv:2404.14831, 2024 | https://arxiv.org/abs/2404.14831 ✅ · code: https://github.com/tshu-w/uniblocker · local: [UniBlock [READ THIS].pdf](../source_papers/UniBlock%20%5BREAD%20THIS%5D.pdf) |
| `strojny2026` | whitepaper | Strojny & Beręsewicz, "BlockingPy: approximate nearest neighbours for blocking of records for entity resolution", *SoftwareX* 34:102583, 2026 | https://doi.org/10.1016/j.softx.2026.102583 ✅ · code: https://github.com/ncn-foreigners/BlockingPy · local: [BlockingPy [READ THIS].pdf](../source_papers/BlockingPy%20%5BREAD%20THIS%5D.pdf) |
