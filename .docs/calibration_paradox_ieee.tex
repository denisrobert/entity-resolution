...
\begin{equation}
\begin{split}
\text{match iff}\quad w(\gamma)\;\ge\;t-b &=\; \log_2\frac{\tau}{1-\tau}-\log_2\frac{\lambda}{1-\lambda}\\
&=:\; w_\tau^*(\lambda).
\end{split}
\label{eq:threshold}
\end{equation}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{figures/paradox_mech1.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{figures/paradox_mech2.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{figures/paradox_mech1_synth.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{figures/paradox_mech2_synth.png}
