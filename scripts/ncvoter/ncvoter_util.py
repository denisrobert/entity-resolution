...
__PATH_CURRENT = Path(__file__).resolve().parent
__PROJECT_ROOT = __PATH_CURRENT.parent.parent
sys.path.insert(0, str(__PROJECT_ROOT))
sys.path.insert(0, str(__PROJECT_ROOT / "scripts"))
sys.path.insert(0, str(__PATH_CURRENT))
