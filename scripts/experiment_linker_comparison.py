...
# Make the project root and scripts/ importable regardless of how invoked.
...
from continuous_linker import (
    DECAY_FIELD,
    FIELDS,
    ContinuousLinker,
    decay_weight,
)
from entity_pipeline import Blocker, Linker, default_comparisons  # noqa: E402
...
def run(args):
    ...
    if args.train_splink:
        ...
        from entity_pipeline import Linker as _L, Blocker as _B  # noqa: E402
