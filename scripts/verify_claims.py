...
CLAIMS = [
    ...
    dict(id="nc-f1", section="9", desc="NC-voter mutated resolution F1",
         ...
         domain="pct", tol=0.1, tex_anchor="Real-Schema Replication"),
    dict(id="nc-recall", section="9", desc="NC-voter mutated recall",
         ...
         domain="pct", tol=0.2, tex_anchor="Real-Schema Replication"),
    ...
    dict(id="cm-recall", section="8", desc="baseline confusion-matrix recall",
         ...
         domain="pct", tol=0.02, tex_anchor="confusion matrix"),
    dict(id="cm-br", section="8", desc="confusion-matrix same-set blocking recall @k=20",
         artifact="results/erwhitepaper/confusion_matrix_results.json", json_path=["blocking_recall", "overall_recall"],
         domain="pct", tol=0.02, tex_anchor="blocking recall is"),
